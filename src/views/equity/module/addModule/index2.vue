<template>
    <div>
        <div class="box">
                    ...
                    <div class="grid-content bg-purple-light">
                        <div id="ComponentFactory">
                            <el-form ref="form" :model="form" label-width="110px">
                                ...
                                <div class="item" id="item12" draggable="true" @dragstart='copydrop($event)'>
                                    <el-form-item label="图片">
                                        <el-color-picker v-model="form.color"></el-color-picker>
                                    </el-form-item>
                                </div>
                                <div class="item" id="item13" draggable="true" @dragstart='copydrop($event)'>
                                    <el-form-item label="链接">
                                        <el-color-picker v-model="form.color"></el-color-picker>
                                    </el-form-item>
                                </div>
                                <div class="item" id="item14" draggable="true" @dragstart='copydrop($event)'>
            ...
            <!--模态框-->
            <el-dialog title="修改名称" :visible.sync="dialogFormVisible" width="50%">
                <el-form :model="form">
