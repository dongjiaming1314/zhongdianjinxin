      ...
      <el-row>
        <el-col :span="12">
          <el-row>
            ...
            <el-col :span="16">{{ form.userName }}</el-col>
          </el-row>
        </el-col>
        <el-col :span="12">
          <el-row>
            <el-col :span="8">登录账号：</el-col>
            <el-col :span="16">{{ form.userNo }}</el-col>
          </el-row>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-row>
            ...
            <el-col :span="16">{{ form.phoneNum }}</el-col>
          </el-row>
        </el-col>
        <el-col :span="12">
          <el-row>
            <el-col :span="8">所属供应商：</el-col>
            <el-col :span="16">{{ form.supId }}</el-col>
          </el-row>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <el-row>
            ...
            <el-col :span="16">{{ form.password }}</el-col>
          </el-row>
        </el-col>
        <el-col :span="12">
          <el-row>
